...
<%@page import="com.bits.cms.entity.Speaker"%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<% ArrayList<Speaker> speakerList = new ArrayList<Speaker>();
					speakerList = (ArrayList<Speaker>)session.getAttribute("SPEAKERLIST");
				%>
				<table border="2" align="center" class ="table table-striped .table-bordered table-hover">
					<tr>
						<th>Speaker ID</th>
						<th>Speaker Name</th>
					...
					%>
					<tr>
						<td align="center"><%=speaker.getSpeakerid()%></td>
						<td align="center"><%=speaker.getSpeakername()%></td>
						<td align="center"><%=speaker.getDesignation()%></td>
						<td align="center">
