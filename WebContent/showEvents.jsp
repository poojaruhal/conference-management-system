...
<%@page import="com.bits.cms.entity.Events"%>
<%@page import="com.bits.cms.entity.Keydates"%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div id="partners" class="container spacer ">
 <%
                	...
                	eventList = (ArrayList<Events>) session.getAttribute("EVENTLIST");
                	ArrayList<Keydates> keydateList = new ArrayList<Keydates>();
                	keydateList = (ArrayList<Keydates>) session.getAttribute("EVENTDATES");
                %>
                <form method="post" action="AttendeeServlet" class ="form-horizontal">
                <input type="hidden" value="registerforevent" name="action">
                <table class ="table table-striped .table-bordered table-hover">
                <tr><td>
				<table float="left" class ="table table-striped .table-bordered table-hover">
					<tr>
						<th>Event Name</th>
						<th>Event Type</th>
				...
				<tr>
					...
					<%
						...
						for(Keydates kd : keydateList) {
					
					%>
					<tr>
						<td align="center"><%=kd.getStarttime()%></td>
						<td align="center"><%=kd.getEndtime()%></td>
						<td align="center"><%=kd.getStartdate()%></td>
						<td align="center"><%=kd.getEnddate()%></td>
						<td align="center">
							<form method ="post" action="AttendeeServlet" class ="form-horizontal">
								<input type="hidden" name="action" value="registerforevent">
								<input type="hidden" name="eventname" value="<%= kd.getEventname() %>">
								<div class="col-sm-6">
