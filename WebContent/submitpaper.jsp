...
<li class ="active">
     ...
     <li class="dropdown">
      <a class="dropdown-toggle" data-toggle="dropdown" href="#menu">Author <span class="caret"></span></a>
      <ul class="dropdown-menu">
        <li ><a href="#menu" onclick="show('submitpaperform')">Submit Paper</a></li>
        <li><a href="#menu" onclick="show('withdrawpaperform')">Withdraw Paper</a></li>
        
        
       
        
        
         <li><a href="#" onclick="show('trackpaperform')">Track Paper</a></li>
...
<form method="post" action="UploadServlet" enctype="multipart/form-data" id="submitpaperform" class ="form-horizontal">
<div class="fileinput fileinput-new" data-provides="fileinput">
    <span class="btn btn-default btn-file"><span>Submit Paper File</span><input type="file" /></span>
