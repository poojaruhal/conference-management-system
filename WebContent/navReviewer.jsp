...
<html>
	...
	function show(target) {
		if (target == 'reviewpaperform') {
			document.getElementById('reviewpaperform').style.display = "block";
		}
	}
</script>
            <body>
				...
				%>
						...
						%>
                                    ...
                                    <li>
                                        ...
                                        <ul class="sub-menu">
                                            <li onclick="show('reviewpaperform')">
                                                <a href="#">REVIEW
										PAPER</a>
                                            </li>
                                        </ul>
                ...
                <div class="row main-low-margin text-center">
                    <form method="post" action="ReviewerServlet" id="reviewpaperform"
			style="display: none">
                        <input type="hidden" value="showpapers" name="action">
                                <input type="submit" value="Show list of pending papers">
                                </form>
                            </div>
