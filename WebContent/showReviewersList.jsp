...
<%@page import="com.bits.cms.entity.Reviewer"%>
<!DOCTYPE html>
<html lang="en">
<head>
...
<%ArrayList<Reviewer> reviewerList = new ArrayList<Reviewer>();
                	reviewerList = (ArrayList<Reviewer>)session.getAttribute("REVIEWERLIST");
                %>
...
<table border="2" class ="table table-striped .table-bordered table-hover">
					...
					%>
					<tr>
						<td align="center"><%=rev.getFirstname()%></td>
						<td align="center"><%=rev.getLastname()%></td>
						<td align="center"><%=rev.getPhonenumber()%></td>
						<td align="center"><%=rev.getEmail()%></td>
						<td align="center"><%=rev.getQualification()%></td>
						<td align="center"><%=rev.getUsername()%></td>
						<td align="center"><%=rev.getPassword()%></td>
						<td align="center"><%=rev.getRole()%></td>
						<td align="center"><%=rev.getExpertarea()%></td>
						<td align="center">
						
							
						<a href="EditorServlet?username=<%=rev.getUsername()%>&delete=reviewer">Delete </a>
						</td>
					</tr>
					<%
						}
